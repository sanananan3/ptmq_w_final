from model.resnet import resnet18 as _resnet18
from model.resnet import resnet50 as _resnet50
from model.mobilenetv2 import mobilenetv2 as _mobilenetv2
from model.mnasnet import mnasnet as _mnasnet
from model.regnet import regnetx_600m as _regnetx_600m
from model.regnet import regnetx_3200m as _regnetx_3200m
...
def regnetx_600m(pretrained=False, **kwargs):
    kwargs.pop('num_classes', None)  # Remove 'num_classes' if present
    # Call the model, load pretrained weights
